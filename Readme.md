No, **pip** and **chmod** are one-time setup steps and are not required for regular daily use once your environment is configured.

Here is the cleaned, concise version of the README.md file without those setup steps, icons, or special characters.
